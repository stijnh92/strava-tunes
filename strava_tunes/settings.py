"""
Django settings for strava_tunes project.
...
SECRET_KEY = '1k!1e+ck33^s(qmx!wb-szf8rt7(qn5evr7)y@)*wqw(@*bldz'
...
ROOT_URLCONF = 'strava_tunes.urls'
...
WSGI_APPLICATION = 'strava_tunes.wsgi.application'
